...
export const ExpandUpIcon = ({ size, color, ...rest }) => (
    <svg height={ `${ size }px` } width={ `${ size }px` } viewBox="0 0 16 16" fill={ color } style={{ transition: 'fill 500ms' }} { ...rest }>
...
export const ExpandDownIcon = ({ size, color, ...rest }) => (
    <svg width={ `${ size }px` } height={ `${ size }px` } viewBox="0 0 16 16" fill={ color } style={{ transition: 'fill 500ms' }} { ...rest }>
