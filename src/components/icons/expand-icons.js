...
export const ExpandUpIcon = ({ size, color }) => (
    <svg height={ `${ size }px` } width={ `${ size }px` } viewBox="0 0 16 16" fill={ color } style={{ transition: 'fill 500ms' }}>
...
export const ExpandDownIcon = ({ size, color }) => (
    <svg width={ `${ size }px` } height={ `${ size }px` } viewBox="0 0 16 16" fill={ color } style={{ transition: 'fill 500ms' }}>
