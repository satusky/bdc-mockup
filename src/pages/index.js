...
const IndexPage = () => (
    <PageContent>
        ...
        <Hero clipped
            ...
            backgroundImage="https://picsum.photos/900/300"
        ...
        <Container width="90%" maxWidth="1200px" center>
            <Grid fluid>
                <Row gutterWidth={ 48 }>
                    <Col xs={ 12 } md={ 12 } lg={ 6 }>
                        <Card>
                            <CardHeader size="large">
                                What can BioData Catalyst <br/> do for you?
                            </CardHeader>
                            <CardBody>
                                <Paragraph>
                    ...
                    <Visible xs sm md>
                        <Col xs={ 12 }><LineBreak count={ 3 } /></Col>
                    </Visible>
                    <Col xs={ 12 } md={ 12 } lg={ 6 }>
                        <img src="https://picsum.photos/400/400" alt="Random image" style={{ width: '100%', height: 'auto', boxShadow: '0 0 8px 2px rgba(0, 0, 0, 0.25)' }} />
                        <LineBreak count={ 3 } />
                        <img src="https://picsum.photos/401/401" alt="Random image" style={{ width: '100%', height: 'auto', boxShadow: '0 0 8px 2px rgba(0, 0, 0, 0.25)' }} />
                    </Col>
                </Row>
            </Grid>
        </Container>
